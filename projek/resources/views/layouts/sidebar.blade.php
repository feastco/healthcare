@php
    ...
    $menuGroups = Navigation::forRoles($roles);
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/"
            ...
            <span
                ...
                class="text-base font-semibold text-gray-800 dark:text-white/90 leading-tight">
                PKU Healthcare<br>
                <span class="text-xs font-normal text-gray-500 dark:text-gray-400">Operations Management</span>
            </span>
            <span
                x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <nav class="mb-6">
            <div class="flex flex-col gap-4">
                @forelse ($menuGroups as $groupIndex => $menuGroup)
                    <div>
                        <!-- Menu Group Title -->
